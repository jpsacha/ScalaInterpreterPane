...
addSbtPlugin("com.eed3si9n" % "sbt-assembly" % "0.8.5")     // provides standalone `assembly` task

addSbtPlugin("com.eed3si9n" % "sbt-buildinfo" % "0.2.0")    // provides version information to copy into main class

addSbtPlugin("de.sciss" % "sbt-appbundle" % "1.0.0")        // provdes standalone OS X `appbundle` task
